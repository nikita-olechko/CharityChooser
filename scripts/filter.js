const continents = [
    'input# North America', 'input# South America', 'input# Africa', 'input# Europe', 'input# Asia', 'input# Australia'
    ]

const events = [
    'input# Hurricane', 'input# Earthquake', 'input# Flood', 'input# Heat Wave', 'input# Wildfire', 'input# Drought',
    'input# Cyclone', 'input# Tsunami', 'input# Transportation Disruption', 'input# Tornado', 'input# Avalanche',
    'input# Oil Spill', 'input# Landslide', 'input# Sharknado'
    ]
...
function ListOfFilteredCards(allCharities) {
